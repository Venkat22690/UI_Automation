...
public class Questionaire_Page19_PartnerCompanyRole {
	WebDriver driver;
	...
	// Object Repositories 
		...
		@FindBy(xpath = "//div[text()='How is this income taxed?']")
		WebElement SelfEmployemntPageTitle;
		
		@FindBy(xpath = "//div[text()='How is this income taxed?']//following:: img[2]")
		WebElement SelfEmployemntPageEntry;
	...
	public Questionaire_Page19_PartnerCompanyRole(WebDriver driver,ExtentReports report,ExtentTest test) throws IOException
	{
	...
	public void Questionaire_PartnerCompanyRole() throws IOException, InterruptedException
	{
		Thread.sleep(4000);
		
		String Partnername = props.getProperty("PartnerName");
		String PartnerRoleTitle = "//div[contains(text(),'Tell us about "+Partnername+"')]";
		...
		// Partner Current Role Title
		if(driver.findElement(By.xpath(PartnerRoleTitle)).isDisplayed())
		{
			test.log(LogStatus.PASS,test.addScreenCapture(Shot.CaptureScreen())+ "Parnter Current Role Title is Available");
		}
		else
		{
			test.log(LogStatus.FAIL,test.addScreenCapture(Shot.CaptureScreen())+ "Parnter Current Role Title is NOT Available");
		}
