...
public class Questionaire_Page18_Customer_HSAOption {
	WebDriver driver;
	...
	// Object Repositories 
		...
		@FindBy(xpath = "//div[contains(text(),'How much will your company contribute to your HSA this year?')]")
	...
	public Questionaire_Page18_Customer_HSAOption(WebDriver driver,ExtentReports report,ExtentTest test) throws IOException
	{
	...
	public void Questionaire_Customer_HSAOption() throws IOException
	{
		// Page Title
		...
		if(CompanyHSA_Label.isDisplayed())
		{
