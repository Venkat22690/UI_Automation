...
public class Questionaire_Page13_CompanyOffer_Onstocks {
	WebDriver driver;
	...
	// Object Repositories 
		...
		@FindBy(xpath = "//div[contains(text(),'Does your current job offer any of the following?')]")
	...
	public Questionaire_Page13_CompanyOffer_Onstocks(WebDriver driver,ExtentReports report,ExtentTest test) throws IOException
	{
	...
	public void Questionaire_CompanyOffer_Onstocks() throws IOException, InterruptedException
	{
		Thread.sleep(4000);
		// Page Title
