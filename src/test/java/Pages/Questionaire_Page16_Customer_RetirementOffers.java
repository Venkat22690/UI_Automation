...
public class Questionaire_Page16_Customer_RetirementOffers {
	WebDriver driver;
	...
	// Object Repositories 
		...
		@FindBy(xpath = "//div[contains(text(),'What benefits does your company offer?')]")
		WebElement CompanyOffers_Label;
		
		@FindBy(xpath = "//div[contains(text(),'Select all that your company offers, even if you aren’t using them today.')]")
		WebElement CompanyOffers_Sub_Label;
	...
	public Questionaire_Page16_Customer_RetirementOffers(WebDriver driver,ExtentReports report,ExtentTest test) throws IOException
	{
	...
	public void Questionaire_Customer_RetirementOffers() throws IOException, InterruptedException
	{
		Thread.sleep(4000);
		// Page Title
		...
		if(CompanyOffers_Label.isDisplayed())
		{
